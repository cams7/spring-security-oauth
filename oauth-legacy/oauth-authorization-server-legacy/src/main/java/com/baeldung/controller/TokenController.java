...
public class TokenController {
  ...
  @RequestMapping(method = GET, value = "/oauth/token/revokeById/{tokenId}")
  @ResponseBody
  public void revokeToken(@PathVariable String tokenId) {
    tokenServices.revokeToken(tokenId);
  }

  @RequestMapping(method = GET, value = "/tokens/{clientId}")
  @ResponseBody
  ...
  @RequestMapping(method = GET, value = "/tokens/revokeRefreshToken/{tokenId}")
  @ResponseBody
